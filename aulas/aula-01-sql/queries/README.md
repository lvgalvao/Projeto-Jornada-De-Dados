# 📚 Queries de Exemplo - Aula 1: SQL & Analytics

Esta pasta contém **21 exemplos SQL** organizados em progressão didática. **Cada exemplo introduz um novo conceito SQL** e responde a uma pergunta de negócio real.
